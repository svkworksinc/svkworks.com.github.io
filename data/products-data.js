...
const SVK_PRODUCTS_DATA = {
  "products": [
    {
      ...
      "price": 1200,
      "image": "img/placeholder-harness.svg",
      "images": ["img/placeholder-harness.svg"],
      "badge": "Popular",
    ...
    {
      "id": "sc400-1uzfe-standalone",
      "name": "Lexus SC400 1UZ-FE Standalone Harness",
      "slug": "sc400-1uzfe-standalone",
      "category": "other",
      "engine": "1UZ-FE",
      "tags": ["1uz", "sc400", "lexus", "standalone", "v8"],
      "price": 1250,
      "image": "img/placeholder-harness.svg",
      "images": ["img/placeholder-harness.svg"],
      "badge": "New",
      "shortDesc": "Complete standalone harness for the 1UZ-FE V8 in the SC400 chassis.",
      "description": "Full standalone wiring harness for the legendary 1UZ-FE V8. Designed for the Lexus SC400 but can be adapted for universal swap applications. Clean, reliable, and ready for aftermarket ECU control.",
      "specs": {
        "Engine": "1UZ-FE VVTi / Non-VVTi",
        "Chassis": "Lexus SC400 (Z30)",
        "Wire Type": "TXL Cross-Linked Polyethylene",
    ...
    {
      "id": "sc300-2jzgte-standalone",
      "name": "Lexus SC300 2JZ-GTE Swap Harness",
      "slug": "sc300-2jzgte-standalone",
      "category": "other",
      "engine": "2JZ-GTE",
      "tags": ["2jz", "sc300", "lexus", "standalone", "swap", "turbo"],
      "price": 1300,
      "image": "img/placeholder-harness.svg",
      "images": ["img/placeholder-harness.svg"],
      "badge": "",
      "shortDesc": "2JZ-GTE swap harness for the Lexus SC300. Full standalone with chassis integration.",
      "description": "Standalone wiring harness for the popular 2JZ-GTE swap into the Lexus SC300 (Soarer). Includes full chassis integration for gauges, AC, and power systems.",
      "specs": {
        "Engine": "2JZ-GTE VVTi / Non-VVTi",
        "Chassis": "Lexus SC300 (Z30)",
        "Wire Type": "TXL Cross-Linked Polyethylene",
        "Connector Type": "OEM Toyota / Deutsch",
        "ECU Compatibility": "Haltech, Link, AEM, Motec",
        "Lead Time": "5-7 weeks"
    ...
    {
      "id": "k24-race-harness",
      "name": "K24 Full Race Standalone Harness",
      "slug": "k24-race-harness",
      "category": "other",
      "engine": "K24",
      "tags": ["k24", "honda", "race", "standalone", "custom"],
      "price": 1500,
      "image": "img/placeholder-harness.svg",
      "images": ["img/placeholder-harness.svg"],
      "badge": "Race",
      "shortDesc": "Full race-tier standalone harness for the Honda K24. Mil-spec, lightweight, and competition ready.",
      "description": "Competition-grade standalone wiring harness for the Honda K24 engine. Built with Raychem mil-spec wire, autosport connectors, and designed for minimal weight. Ideal for time attack, drift, and circuit racing applications.",
      "specs": {
        "Engine": "K24A / K24Z",
        "Chassis": "Universal / Custom",
        "Wire Type": "Raychem Spec 44",
        "Connector Type": "Autosport / Deutsch DTM",
        "ECU Compatibility": "Haltech, Link, AEM, Motec",
        "Weight": "Under 2 lbs",
        "Lead Time": "5-7 weeks"
      },
      "options": {
        "ECU Type": ["Haltech Elite", "Link G4X", "AEM Infinity", "Motec M1", "Other"],
        "Connector Level": ["Standard Deutsch", "Autosport AS"]
      },
      "inStock": true,
      "featured": true
    },
    {
      ...
      "category": "other",
      "engine": "1UZ-FE",
      "tags": ["1uz", "universal", "swap", "standalone", "v8"],
      "price": 1150,
      "image": "img/placeholder-harness.svg",
      "images": ["img/placeholder-harness.svg"],
      "badge": "",
      "shortDesc": "Universal standalone harness for 1UZ-FE swap into any chassis.",
      "description": "Versatile standalone harness for the 1UZ-FE V8 engine. Designed with extended leads and universal connector options for swap into non-Toyota chassis applications.",
      "specs": {
        "Engine": "1UZ-FE VVTi / Non-VVTi",
        "Chassis": "Universal",
        "Wire Type": "TXL Cross-Linked Polyethylene",
      ...
      "options": {
        "ECU Type": ["Haltech Elite", "Link G4X", "AEM Infinity", "Other"],
        "VVTi": ["VVTi", "Non-VVTi"],
        "Lead Length": ["Standard (4ft)", "Extended (6ft)", "Custom"]
      },
      "inStock": true,
      "featured": false
    },
  ...
  "builds": [
    {
      "id": "joes-mk4-single-turbo",
      "title": "Joe's MK4 Single Turbo 2JZ",
      "owner": "Joe M.",
      "type": "customer",
      "specs": "2JZ-GTE | Precision 6766 | Haltech Elite 2500 | 750whp",
      "description": "Clean MK4 build with a Precision 6766 turbo kit, full standalone SVK harness, and Haltech Elite 2500 ECU. Built for street and occasional track days.",
      "image": "img/placeholder-build.svg",
      "images": ["img/placeholder-build.svg"],
      "tags": ["mk4", "2jz", "turbo", "haltech"]
    },
    {
      "id": "svk-mk3-project",
      "title": "SVK Shop MK3 2JZ Build",
      "owner": "SVK Works",
      "type": "shop",
      "specs": "2JZ-GTE | BorgWarner EFR 8374 | Link G4X | 680whp",
      "description": "Our in-house MK3 Supra project. Full 2JZ-GTE swap with BorgWarner EFR turbo, Link G4X ECU, and of course a complete SVK standalone harness.",
      "image": "img/placeholder-build.svg",
      "images": ["img/placeholder-build.svg"],
      "tags": ["mk3", "2jz", "turbo", "link"]
    },
    {
      "id": "sc400-drift-build",
      "title": "SC400 1UZ Drift Build",
      "owner": "Tyler R.",
      "type": "customer",
      "specs": "1UZ-FE | ITBs | Haltech Elite 2500 | NA Power",
      "description": "Naturally aspirated 1UZ-FE with individual throttle bodies in a Lexus SC400. SVK standalone harness keeps it all clean and reliable for drift events.",
      "image": "img/placeholder-build.svg",
      "images": ["img/placeholder-build.svg"],
      "tags": ["sc400", "1uz", "drift", "haltech"]
    },
    {
      "id": "k24-time-attack",
      "title": "K24 Time Attack EK Civic",
      "owner": "SVK Works",
      "type": "shop",
      "specs": "K24A2 | Garrett GTX3076 | Motec M150 | Full Race Harness",
      "description": "Full race-tier SVK harness on a time attack EK Civic with K24 turbo swap. Raychem mil-spec wiring, autosport connectors, under 2 lbs total harness weight.",
      "image": "img/placeholder-build.svg",
      "images": ["img/placeholder-build.svg"],
      "tags": ["k24", "honda", "race", "motec"]
    }
  ]
};
