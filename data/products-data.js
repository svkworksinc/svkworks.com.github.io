...
const SVK_PRODUCTS_DATA = {
  "products": [
    ...
    },
    {
      ...
      "shortDesc": "16-pin body connector kit for the MK4 Supra JZA80 — OEM 90980-11562, white footwell. Housing, terminals and seals included.",
      "description": "16-pin body connector kit for the MK4 (MKIV) Toyota Supra JZA80 — Toyota OEM part number 90980-11562, the white 16-pin footwell connector. One of the three connectors joining the engine harness to the body harness. Supplied as a kit with the connector housing plus terminals and weather seals for all 16 positions. OEM Toyota compatible with correct fit, terminal sizing and retention. Fits 1993–2002 with 2JZ-GTE or 2JZ-GE.",
      "specs": {
        ...
        "Kit Contents": "Housing, terminals and seals for all 16 positions",
    ...
    },
    {
      ...
      "specs": {
        ...
        "Engines": "2JZ-GTE (turbo) and 2JZ-GE (NA)",
        "Application": "Footwell body connector — engine harness to body harness",
        "Kit Contents": "Housing, terminals and seals for all 20 positions",
        "Type": "OEM Toyota compatible, sealed",
        "Warranty": "1-year workmanship warranty"
      },
      "options": {},
    ...
    },
    {
      ...
      "shortDesc": "Complete 38-pin body connector kit for the MK4 Supra JZA80 — OEM 90980-11555, orange footwell. Housing, terminals and seals included.",
    ...
    },
    {
      ...
      "name": "MK4 Supra Body Connector Kit Set — 16P + 20P + 38P (JZA80)",
      ...
      "description": "Complete set of all three MK4 Supra (JZA80) footwell body connectors — the white 16-pin (Toyota OEM 90980-11562), gray 20-pin (90980-11469) and orange 38-pin (90980-11555). These are the three connectors joining the engine harness to the body harness. Each kit includes the connector housing plus terminals and weather seals for every position. Buying the set saves $20 over purchasing the three individually — the best value for a full chassis harness restoration or 2JZ swap.",
      "specs": {
        ...
        "Kit Contents": "Housings, terminals and seals for every position",
        "Type": "OEM Toyota compatible, sealed",
        "Warranty": "1-year workmanship warranty"
      },
      "options": {},
