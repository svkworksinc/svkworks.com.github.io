...
const SVK_PRODUCTS_DATA = {
  "products": [
    ...
    },
    {
      ...
      "name": "2JZ OEM Connector Kit",
      "slug": "oem-connector-kit-2jz",
      "category": "connectors",
      "engine": "2JZ",
      "tags": ["2jz", "connectors", "parts", "oem", "toyota-oem"],
      "price": 185,
      "image": "img/milspec1.jpg",
      "images": ["img/milspec1.jpg"],
      "badge": "In Stock",
      "shortDesc": "Complete OEM connector set for the 2JZ-GTE and 2JZ-GE — injectors, coils, all sensors. 28+ connectors with pins.",
      "description": "Full set of OEM-spec connectors for the 2JZ engine platform. Includes injector plugs, coil connectors, TPS, MAP, IAT, coolant temp, cam/crank sensors, and more. Perfect for harness builders or DIY repairs. Every connector is OEM Toyota compatible — correct fit, correct sealing, correct terminal retention for reliable long-term connections.",
      "specs": {
        "Engine": "2JZ-GTE / 2JZ-GE",
        "Includes": "Injector, coil, sensor connectors",
        "Type": "OEM Toyota compatible",
        "Pieces": "28+ connectors with pins",
    ...
    {
      "id": "oem-connector-kit-1jz",
      "name": "1JZ OEM Connector Kit",
      "slug": "oem-connector-kit-1jz",
      "category": "connectors",
      "engine": "1JZ",
      "tags": ["1jz", "connectors", "parts", "oem", "toyota-oem"],
      "price": 165,
      "image": "img/milspec1.jpg",
      "images": ["img/milspec1.jpg"],
      "badge": "In Stock",
      "shortDesc": "Complete OEM connector set for the 1JZ-GTE engine — injectors, coils, and all sensor positions.",
      "description": "Full set of OEM-spec connectors for the 1JZ engine. Includes all sensor, injector, and coil connectors needed for a complete harness build. OEM Toyota compatible — correct terminal sizing, correct sealing, correct fit.",
      "specs": {
        "Engine": "1JZ-GTE",
        "Includes": "Injector, coil, sensor connectors",
        "Type": "OEM Toyota compatible",
        "Pieces": "24+ connectors with pins",
        "Warranty": "1-year workmanship warranty"
      },
      "options": {},
      "inStock": true,
    ...
    {
      "id": "oem-connector-kit-7m",
      "name": "7M-GTE OEM Connector Kit",
      "slug": "oem-connector-kit-7m",
      "category": "connectors",
      "engine": "7M-GTE",
      "tags": ["7m", "connectors", "parts", "oem", "toyota-oem", "mk3"],
      "price": 145,
      "image": "img/milspec1.jpg",
      "images": ["img/milspec1.jpg"],
      "badge": "In Stock",
      "shortDesc": "Complete OEM connector set for the 7M-GTE engine in the MK3 Supra. All injector, coil, and sensor connectors with pins.",
      "description": "Full set of OEM-spec connectors for the 7M-GTE engine as found in the MK3 Supra. Covers all injector, igniter, and sensor connector positions. Perfect for harness rebuilds on original 7M-powered cars or standalone harness builds.",
      "specs": {
        "Engine": "7M-GTE",
        "Chassis": "MK3 Supra (MA70)",
        "Includes": "Injector, igniter, sensor connectors",
        "Type": "OEM Toyota compatible",
        "Pieces": "22+ connectors with pins",
        "Warranty": "1-year workmanship warranty"
      },
      "options": {},
      "inStock": true,
    ...
    {
      "id": "oem-connector-kit-1uz",
      "name": "1UZ-FE OEM Connector Kit",
      "slug": "oem-connector-kit-1uz",
      "category": "connectors",
      "engine": "1UZ-FE",
      "tags": ["1uz", "connectors", "parts", "oem", "toyota-oem", "v8", "lexus"],
      "price": 175,
      "image": "img/milspec1.jpg",
      "images": ["img/milspec1.jpg"],
      "badge": "In Stock",
      "shortDesc": "Complete OEM connector set for the 1UZ-FE V8 — all 8 injectors, coil connectors, and sensor positions.",
      "description": "Full set of OEM-spec connectors for the 1UZ-FE V8 engine. Covers all 8 injector positions, individual coil connectors (VVT-i), and all sensor positions including cam/crank, IAT, coolant temp, and TPS. Compatible with both VVT-i and Non-VVT-i variants.",
      "specs": {
        "Engine": "1UZ-FE VVT-i / Non-VVT-i",
        "Includes": "8x injector, coil, all sensor connectors",
        "Type": "OEM Toyota / Lexus compatible",
        "Pieces": "32+ connectors with pins",
        "Warranty": "1-year workmanship warranty"
      },
      "options": {},
      "inStock": true,
